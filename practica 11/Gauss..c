...
for(j=0;j<5;j++){
    if(j==0){ // x_1 x_2 y x_3 son cero en la iteracion 1 
        ...
        y=x_iteracion_2 = ((-A[1][0]*x_iteracion_1)+b[1])/A[1][1];
        z=x_iteracion_3 = ((-A[2][0]*x_iteracion_1)-(A[2][1]*x_iteracion_2)+b[2])/A[2][2];
        ...
        erpx= ((x_iteracion_1 - x)/x_iteracion_1)*100;
        erpy= ((x_iteracion_2 - y)/x_iteracion_2)*100;
        erpz= ((x_iteracion_3 - z)/x_iteracion_3)*100;
        x=x_iteracion_1;
        y=x_iteracion_2;
        z=x_iteracion_3;
